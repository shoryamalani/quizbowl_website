    ...
    return (
        <Fragment>
            ...
            <View style={{
                ...
                <TextInput placeholder='Search for a clue here' placeholderTextColor='black' style={styles.textInput} />
            </View>
            <SafeAreaView>
                {data == null && (
                    <Text>Loading...</Text>
...
{/* Basic Template for each clue search bubble below:  */}
...
export default ClueSearchScreen;
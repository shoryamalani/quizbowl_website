...
def main():
    ...
    users_table_list = [["UUID","SERIAL PRIMARY KEY"],["username","text"],["sign_in_count","int"],["last_sign_in","timestamp"],['user_token',"text"],["created_at","timestamp"],["questions_attempted","integer"],["questions_correct","integer"],["xp","integer"],["rank","integer"],["public","boolean"],["user_data","json"]]
